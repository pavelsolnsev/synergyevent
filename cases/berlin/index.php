...
<section class="main " id="main" data-bg-desktop="img/@cases/@berlin/main/bg_d.jpg" data-bg-tablet="img/@cases/@berlin/main/bg_t.jpg" data-bg-mobile="img/@cases/@berlin/main/bg.jpg">
	...
	<div class="container">
		...
		<h1 class="main__title">Штурм Берлина</h1>
		

		
		<div class="main__subtitle">Военно-историческая реконструкция</div>
	...
	<div class="container">
		...
		<div class="row no-gutters">
			<div class="col-lg-7 about__col-1">
				...
				<div class="about__text">Патриотическое воспитание молодежи в&nbsp;современном формате. Повышение исторической грамотности населения.</div>
...
<section class="video" id="video" style="background-image: url('img/@cases/@berlin/video/bg_d.jpg')">

	<a href="https://youtu.be/qbJe7ZClv_c" target="_blank" data-fancybox class="video__link">
...
<section class="stats lazy" id="stats">
	<div class="container">
		...
		<div class="stats__subtitle">В&nbsp;парке &laquo;Патриот&raquo; были воспроизведены танковые бои, дуэли истребительной авиации, а&nbsp;также действия подразделений пехоты решающей битвы Великой Отечественной войны. Реконструкция длилась полтора часа и&nbsp;состояла из&nbsp;пяти эпизодов: штурма Зееловских высот, окружения Берлина, попытки прорыва окружения, штурма Берлина и&nbsp;взятия Рейхстага.</div>

		

		<div class="stats__items" data-count="6">
			...
			<div class="stats__item stats__item_1 stats__item_odd ">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">Лучшее образовательное <br> мероприятие 2017 года <br> в России</div>
			...
			<div class="stats__item stats__item_2 stats__item_even ">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">Победитель международной <br> премии Eventex</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_3 stats__item_odd ">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">реконструкторов из 10 стран мираи</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_4 stats__item_even ">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">тыс. зрителей</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_5 stats__item_odd ">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">единиц боевой техники</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_6 stats__item_even ">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">профессиональных каскадеров</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
	...
	<div class="container gallery__container">
		...
		<div class="gallery__slider slick" data-slick='{ "arrows": false, "touch": false, "mobileFirst": true, "slidesToShow": 1, "slidesToScroll": 1, "responsive": [{"breakpoint": 991, "settings": { "slidesToShow": 3, "slidesToScroll": 3 } }] }'>
			...
			<div class="gallery__card" data-groupby="2">
				...
				<a href="img/@cases/@berlin/gallery/01.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@berlin/gallery/01.jpg') ?></a>
				
				
				
				<a href="img/@cases/@berlin/gallery/02.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@berlin/gallery/02.jpg') ?></a>
			...
			<div class="gallery__card" data-groupby="4">
				...
				<a href="img/@cases/@berlin/gallery/03.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@berlin/gallery/03.jpg') ?></a>
				
				
				
				<a href="img/@cases/@berlin/gallery/04.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@berlin/gallery/04.jpg') ?></a>
				
				
				
				<a href="img/@cases/@berlin/gallery/05.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@berlin/gallery/05.jpg') ?></a>
				
				
				
				<a href="img/@cases/@berlin/gallery/06.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@berlin/gallery/06.jpg') ?></a>
			...
			<div class="gallery__card" data-groupby="2">
				...
				<a href="img/@cases/@berlin/gallery/07.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@berlin/gallery/07.jpg') ?></a>
				
				
				
				<a href="img/@cases/@berlin/gallery/08.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@berlin/gallery/08.jpg') ?></a>
...
<a href="/cases/mb/" class="cases__card cases__card_next">
	<div>
...
<a href="/cases/mu/" class="cases__card cases__card_prev">
	<div>

...
<section class="main " id="main" data-bg-desktop="img/@cases/@sgf/main/bg_d.jpg" data-bg-tablet="img/@cases/@sgf/main/bg_t.jpg" data-bg-mobile="img/@cases/@sgf/main/bg.jpg">
	...
	<div class="container">
		...
		<h1 class="main__title">Synergy Global Forum</h1>
		

		
		<div class="main__subtitle">Крупнейший ежегодный бизнес-форум <br class="d-none d-lg-inline">Восточной Европы</div>
...
<section class="video" id="video" style="background-image: url('img/@cases/@sgf/video/bg_d.jpg')">

	<a href="https://youtu.be/i0ZaMTlO8wY" target="_blank" data-fancybox class="video__link">
...
<section class="stats lazy" id="stats">
	<div class="container">
		...
		<div class="stats__subtitle">Форум объединяет участников со&nbsp;всего мира вне&nbsp;зависимости от&nbsp;места проживания и&nbsp;рода деятельности.</div>
		...
		<div class="stats__items" data-count="2">
			...
			<div class="stats__item stats__item_1 stats__item_odd ">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">Общее количество спикеров <br>за&nbsp;все время</div>
			...
			<div class="stats__item stats__item_2 stats__item_even ">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">Общее количество зрителей <br>за все время</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
	...
	<div class="container gallery__container">
		...
		<div class="gallery__slider slick" data-slick='{ "arrows": false, "touch": false, "mobileFirst": true, "slidesToShow": 1, "slidesToScroll": 1, "responsive": [{"breakpoint": 991, "settings": { "slidesToShow": 3, "slidesToScroll": 3 } }] }'>
			...
			<div class="gallery__card" data-groupby="2">
				...
				<a href="img/@cases/@sgf/gallery/01.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@sgf/gallery/01.jpg') ?></a>
				
				
				
				<a href="img/@cases/@sgf/gallery/02.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@sgf/gallery/02.jpg') ?></a>
			...
			<div class="gallery__card" data-groupby="4">
				...
				<a href="img/@cases/@sgf/gallery/03.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@sgf/gallery/03.jpg') ?></a>
				
				
				
				<a href="img/@cases/@sgf/gallery/04.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@sgf/gallery/04.jpg') ?></a>
				
				
				
				<a href="img/@cases/@sgf/gallery/05.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@sgf/gallery/05.jpg') ?></a>
				
				
				
				<a href="img/@cases/@sgf/gallery/06.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@sgf/gallery/06.jpg') ?></a>
			...
			<div class="gallery__card" data-groupby="2">
				...
				<a href="img/@cases/@sgf/gallery/07.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@sgf/gallery/07.jpg') ?></a>
				
				
				
				<a href="img/@cases/@sgf/gallery/08.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@sgf/gallery/08.jpg') ?></a>
...
<a href="/cases/arf2022/" class="cases__card cases__card_next">
	<div>
...
<a href="/cases/mvideo-eldorado/" class="cases__card cases__card_prev">
	<div>

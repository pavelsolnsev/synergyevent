...
<section class="main " id="main" data-bg-desktop="img/@cases/@mb/main/bg_d.jpg" data-bg-tablet="img/@cases/@mb/main/bg_t.jpg" data-bg-mobile="img/@cases/@mb/main/bg.jpg">
	...
	<div class="container">
		...
		<h1 class="main__title">Форум &laquo;Мой бизнес&raquo;</h1>
		

		
		<div class="main__subtitle">Национальный проект по&nbsp;поддержке малого и&nbsp;среднего бизнеса</div>
	...
	<div class="container">
		...
		<div class="row no-gutters">
			<div class="col-lg-7 about__col-1">
				...
				<div class="about__text">Поведение итогов национального проекта, организация обмена опытом между предпринимателями, формирование лучших условий для создания и&nbsp;развития своего дела.</div>
...
<section class="video" id="video" style="background-image: url('img/@cases/@mb/video/bg_d.jpg')">

	<a href="https://youtu.be/6uiMSy8Subc" target="_blank" data-fancybox class="video__link">
		...
		<div class="stats__items" data-count="5">
			...
			<div class="stats__item stats__item_1 stats__item_odd stats__item_small">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">Финальное событие <br> в серии из <span class="stats__item-number">26</span> форумов</div>
			...
			<div class="stats__item stats__item_2 stats__item_even stats__item_small">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">параллельные сцены: <br> &laquo;Маркетинг и&nbsp;продажи&raquo; <br> &laquo;Личная эффективность&raquo; <br>&laquo;Успешные кейсы&raquo;</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_3 stats__item_odd stats__item_small">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">ключевых спикеров</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_4 stats__item_even stats__item_small">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">участников по всей стране</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_5 stats__item_odd stats__item_small">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">участников в Москве</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
...
<section class="stats lazy" id="speakers">
	<div class="container">
		...
		<div class="stats__items" data-count="4">
			
			<div class="stats__item stats__item_1 stats__item_odd ">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						
						<div class="stats__item-num-smaller">Ирина <br> Хакамада</div>
						
					</div>
					<div class="stats__item-text">бизнес-тренер, общественный деятель</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_2 stats__item_even ">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						...
						<div class="stats__item-num-smaller">Аркадий <br> Новиков</div>
						
					</div>
					<div class="stats__item-text">основатель ресторанной группы Novikov Group</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_3 stats__item_odd ">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						...
						<div class="stats__item-num-smaller">Михаил <br> Кучмент</div>
						
					</div>
					<div class="stats__item-text">владелец Hartmann Holdings, <br> сооснователь гипермаркетов мебели <br> и&nbsp;товаров для дома Hoff</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_4 stats__item_even ">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						...
						<div class="stats__item-num-smaller">Евгений <br> Черняк</div>
						
					</div>
					<div class="stats__item-text">бизнесмен из&nbsp;топ-100&nbsp;Forbes, <br> автор популярного обучающего <br> бизнес-канала на&nbsp;YouTube&nbsp;&mdash; Big Money</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
	...
	<div class="container gallery__container">
		...
		<div class="gallery__slider slick" data-slick='{ "arrows": false, "touch": false, "mobileFirst": true, "slidesToShow": 1, "slidesToScroll": 1, "responsive": [{"breakpoint": 991, "settings": { "slidesToShow": 3, "slidesToScroll": 3 } }] }'>
			...
			<div class="gallery__card" data-groupby="2">
				...
				<a href="img/@cases/@mb/gallery/01.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@mb/gallery/01.jpg') ?></a>
				
				
				
				<a href="img/@cases/@mb/gallery/02.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@mb/gallery/02.jpg') ?></a>
			...
			<div class="gallery__card" data-groupby="4">
				...
				<a href="img/@cases/@mb/gallery/03.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@mb/gallery/03.jpg') ?></a>
				
				
				
				<a href="img/@cases/@mb/gallery/04.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@mb/gallery/04.jpg') ?></a>
				
				
				
				<a href="img/@cases/@mb/gallery/05.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@mb/gallery/05.jpg') ?></a>
				
				
				
				<a href="img/@cases/@mb/gallery/06.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@mb/gallery/06.jpg') ?></a>
			...
			<div class="gallery__card" data-groupby="2">
				...
				<a href="img/@cases/@mb/gallery/07.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@mb/gallery/07.jpg') ?></a>
				
				
				
				<a href="img/@cases/@mb/gallery/08.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@mb/gallery/08.jpg') ?></a>
...
<a href="/cases/swf2021/" class="cases__card cases__card_next">
	<div>
...
<a href="/cases/berlin/" class="cases__card cases__card_prev">
	<div>

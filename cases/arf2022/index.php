...
<section class="main " id="main" data-bg-desktop="img/@cases/@arf2022/main/bg_d.jpg" data-bg-tablet="img/@cases/@arf2022/main/bg_t.jpg" data-bg-mobile="img/@cases/@arf2022/main/bg.jpg">
	...
	<div class="container">
		...
		<h1 class="main__title">ArtRussia Fair 2022</h1>
		

		
		<div class="main__subtitle">Ярмарка современного искусства <br class="d-none d-lg-inline">и&nbsp;Международный Art Forum</div>
	...
	<div class="container">
		...
		<div class="row no-gutters">
			<div class="col-lg-7 about__col-1">
				...
				<div class="about__text">Ярмарка современного искусства и&nbsp;международный арт-форум Art Russia&nbsp;&mdash; место, где открываются новые имена, задаются художественные тренды, выстраиваются отношения художников с&nbsp;галереями, развиваются и&nbsp;укрепляются культурные связи между представителями российского искусства и&nbsp;международным арт-сообществом.</div>
...
<section class="video" id="video" style="background-image: url('img/@cases/@arf2022/video/bg_d.jpg')">

	<a href="https://youtu.be/VUpBgIfXFvU" target="_blank" data-fancybox class="video__link">
...
<section class="stats lazy" id="stats">
	<div class="container">
		...
		<div class="stats__subtitle">Флагманский арт-форум Корпорации &laquo;Синергия&raquo;, ежегодно проходящий в&nbsp;Гостином Дворе.</div>

		

		<div class="stats__items" data-count="7">
			...
			<div class="stats__item stats__item_2 stats__item_even stats__item_small">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						...
						<div class="stats__item-num-smaller">20 000+</div>
						
					</div>
					<div class="stats__item-text">посетителей</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_3 stats__item_odd stats__item_small">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						...
						<div class="stats__item-num-smaller">50 000+</div>
						
					</div>
					<div class="stats__item-text">зрителей в онлайн</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_4 stats__item_even stats__item_small">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">спикеров</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_5 stats__item_odd stats__item_small">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">участников-экспонентов</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_6 stats__item_even stats__item_small">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">выступлений и лекций на темы арт-бизнеса и креативных индустрий</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_7 stats__item_odd stats__item_small">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">миллионов рублей выручки от продажи произведений искусства</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
	...
	<div class="container gallery__container">
		...
		<div class="gallery__slider slick" data-slick='{ "arrows": false, "touch": false, "mobileFirst": true, "slidesToShow": 1, "slidesToScroll": 1, "responsive": [{"breakpoint": 991, "settings": { "slidesToShow": 3, "slidesToScroll": 3 } }] }'>
			...
			<div class="gallery__card" data-groupby="2">
				...
				<a href="img/@cases/@arf2022/gallery/01.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@arf2022/gallery/01.jpg') ?></a>
				
				
				
				<a href="img/@cases/@arf2022/gallery/02.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@arf2022/gallery/02.jpg') ?></a>
			...
			<div class="gallery__card" data-groupby="4">
				...
				<a href="img/@cases/@arf2022/gallery/03.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@arf2022/gallery/03.jpg') ?></a>
				
				
				
				<a href="img/@cases/@arf2022/gallery/04.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@arf2022/gallery/04.jpg') ?></a>
				
				
				
				<a href="img/@cases/@arf2022/gallery/05.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@arf2022/gallery/05.jpg') ?></a>
				
				
				
				<a href="img/@cases/@arf2022/gallery/06.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@arf2022/gallery/06.jpg') ?></a>
			...
			<div class="gallery__card" data-groupby="2">
				...
				<a href="img/@cases/@arf2022/gallery/07.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@arf2022/gallery/07.jpg') ?></a>
				
				
				
				<a href="img/@cases/@arf2022/gallery/08.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@arf2022/gallery/08.jpg') ?></a>
...
<a href="/cases/mu/" class="cases__card cases__card_next">
	<div>
...
<a href="/cases/sgf/" class="cases__card cases__card_prev">
	<div>

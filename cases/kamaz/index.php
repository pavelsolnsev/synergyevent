...
<section class="main " id="main" data-bg-desktop="img/@cases/@kamaz/main/bg_d.jpg" data-bg-tablet="img/@cases/@kamaz/main/bg_t.jpg" data-bg-mobile="img/@cases/@kamaz/main/bg.jpg">
	...
	<div class="container">
		...
		<h1 class="main__title">ПАО &laquo;КАМАЗ&raquo;</h1>
		

		
		<div class="main__subtitle">Гала-ужин</div>
	...
	<div class="container">
		...
		<div class="row no-gutters">
			<div class="col-lg-7 about__col-1">
				...
				<div class="about__text">Гала-ужины ПАО &laquo;КАМАЗ&raquo; в&nbsp;рамках выставки COMTRANS 2021 решили сразу две важные задачи&nbsp;&mdash; презентация новых продуктов КАМАЗ и&nbsp;укрепление контактов с&nbsp;ключевыми партнерами в&nbsp;неформальной обстановке.</div>
		...
		<div class="stats__items" data-count="2">
			...
			<div class="stats__item stats__item_1 stats__item_odd ">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">ключевых клиентов, <br> партнёров и&nbsp;дилеров ПАО &laquo;КАМАЗ&raquo;</div>
			...
			<div class="stats__item stats__item_2 stats__item_even ">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">Хэдлайнер - Анна Седокова</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
	...
	<div class="container gallery__container">
		...
		<div class="gallery__slider slick" data-slick='{ "arrows": false, "touch": false, "mobileFirst": true, "slidesToShow": 1, "slidesToScroll": 1, "responsive": [{"breakpoint": 991, "settings": { "slidesToShow": 3, "slidesToScroll": 3 } }] }'>
			...
			<div class="gallery__card" data-groupby="2">
				...
				<a href="img/@cases/@kamaz/gallery/01.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@kamaz/gallery/01.jpg') ?></a>
				
				
				
				<a href="img/@cases/@kamaz/gallery/02.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@kamaz/gallery/02.jpg') ?></a>
			...
			<div class="gallery__card" data-groupby="4">
				...
				<a href="img/@cases/@kamaz/gallery/03.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@kamaz/gallery/03.jpg') ?></a>
				
				
				
				<a href="img/@cases/@kamaz/gallery/04.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@kamaz/gallery/04.jpg') ?></a>
				
				
				
				<a href="img/@cases/@kamaz/gallery/05.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@kamaz/gallery/05.jpg') ?></a>
				
				
				
				<a href="img/@cases/@kamaz/gallery/06.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@kamaz/gallery/06.jpg') ?></a>
			...
			<div class="gallery__card" data-groupby="2">
				...
				<a href="img/@cases/@kamaz/gallery/07.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@kamaz/gallery/07.jpg') ?></a>
				
				
				
				<a href="img/@cases/@kamaz/gallery/08.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@kamaz/gallery/08.jpg') ?></a>
...
<a href="/cases/safmar/" class="cases__card cases__card_next">
	<div>
...
<a href="/cases/smc2019/" class="cases__card cases__card_prev">
	<div>

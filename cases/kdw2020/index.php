...
<section class="main " id="main" data-bg-desktop="img/@cases/@kdw2020/main/bg_d.jpg" data-bg-tablet="img/@cases/@kdw2020/main/bg_t.jpg" data-bg-mobile="img/@cases/@kdw2020/main/bg.jpg">
	...
	<div class="container">
		...
		<h1 class="main__title">KAZAN DIGITAL WEEK 2020</h1>
		

		
		<div class="main__subtitle">Международный форум</div>
	...
	<div class="container">
		...
		<div class="row no-gutters">
			<div class="col-lg-7 about__col-1">
				...
				<div class="about__text">Формирование ежегодной площадки научной, технической и&nbsp;коммерческой коммуникации разработчиков и&nbsp;пользователей технологий, продуктов и&nbsp;услуг цифровой трансформации. <br>
	Достижение максимального научного и&nbsp;экономического эффекта общения специалистов в&nbsp;удалённом формате.</div>
...
<section class="stats lazy" id="stats">
	<div class="container">
		...
		<div class="stats__subtitle">В&nbsp;программе форума&nbsp;&mdash; панельные дискуссии и&nbsp;круглые столы, выставка действующих образцов автономных транспортных средств, технические туры по&nbsp;производствам и&nbsp;лабораториям, экскурсионные туры по&nbsp;Казани, финал летней серии хакатонов Digital Superhero</div>

		

		<div class="stats__items" data-count="0">
			...
			<div class="stats__item stats__item_1 stats__item_odd ">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						...
						<div class="stats__item-num-smaller">Михаил <br> Мишустин </div>
						
					</div>
					<div class="stats__item-text">председатель Правительства РФ</div>
			...
			<div class="stats__item stats__item_2 stats__item_even ">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						...
						<div class="stats__item-num-smaller">Рустам <br> Минниханов</div>
						
					</div>
					<div class="stats__item-text">Президент Республики Татарстан</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
	...
	<div class="container gallery__container">
		...
		<div class="gallery__slider slick" data-slick='{ "arrows": false, "touch": false, "mobileFirst": true, "slidesToShow": 1, "slidesToScroll": 1, "responsive": [{"breakpoint": 991, "settings": { "slidesToShow": 3, "slidesToScroll": 3 } }] }'>
			...
			<div class="gallery__card" data-groupby="2">
				...
				<a href="img/@cases/@kdw2020/gallery/" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@kdw2020/gallery/') ?></a>
...
<a  class="cases__card cases__card_next">
	<div>
		<div class="cases__card-note">Следующий <br>кейс</div>
		<div class="cases__card-title"></div>
	</div>
	<div class="cases__card-header">
		<div class="cases__card-img"><?= img('img/@index/cases/.jpg') ?></div>
	</div><!-- cases__card-header -->
	
</a><!-- cases__card -->
 
			
<a  class="cases__card cases__card_prev">
	<div>

...
<section class="main " id="main" data-bg-desktop="img/@cases/@sfi/main/bg_d.jpg" data-bg-tablet="img/@cases/@sfi/main/bg_t.jpg" data-bg-mobile="img/@cases/@sfi/main/bg.jpg">
	...
	<div class="container">
		...
		<h1 class="main__title">SFI</h1>
		

		
		<div class="main__subtitle">Корпоративный Новый год</div>
	...
	<div class="container">
		...
		<div class="row no-gutters">
			<div class="col-lg-7 about__col-1">
				...
				<div class="about__text">Подведение итогов года, сплочение коллектива и&nbsp;заряд на&nbsp;новые достижения.</div>
...
<section class="stats lazy" id="stats">
	<div class="container">
		...
		<div class="stats__subtitle">Первое новогоднее событие после ребрендинга SFI объединило сотрудников холдинга после непростого года и&nbsp;задало новую планку для мероприятий компании. Вместо скучных презентаций об&nbsp;итогах года&nbsp;&mdash; дерзкий NEWS BLOCK от&nbsp;звезды MTV Александра Анатольевича. Вместо банальных поздравлений&nbsp;&mdash; динамичная игра для сотрудников в&nbsp;стилистике актуального шоу ДЕЛО БЫЛО ВЕЧЕРОМ. Тем не&nbsp;менее, несмотря на&nbsp;новый подход, событию удалось сохранить в&nbsp;себе, присущую SFI открытость и&nbsp;душевность. <br> А&nbsp;финальным аккордом события стало живое выступление неподражаемого Филиппа Киркорова!</div>
		...
		<div class="stats__items" data-count="2">
			...
			<div class="stats__item stats__item_1 stats__item_odd ">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">сотрудников и&nbsp;партнёров SFI</div>
			...
			<div class="stats__item stats__item_2 stats__item_even ">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">первое событие компании <br> после большого ребрендинга</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
	...
	<div class="container gallery__container">
		...
		<div class="gallery__slider slick" data-slick='{ "arrows": false, "touch": false, "mobileFirst": true, "slidesToShow": 1, "slidesToScroll": 1, "responsive": [{"breakpoint": 991, "settings": { "slidesToShow": 3, "slidesToScroll": 3 } }] }'>
			...
			<div class="gallery__card" data-groupby="2">
				...
				<a href="img/@cases/@sfi/gallery/01.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@sfi/gallery/01.jpg') ?></a>
				
				
				
				<a href="img/@cases/@sfi/gallery/02.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@sfi/gallery/02.jpg') ?></a>
			...
			<div class="gallery__card" data-groupby="4">
				...
				<a href="img/@cases/@sfi/gallery/03.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@sfi/gallery/03.jpg') ?></a>
				
				
				
				<a href="img/@cases/@sfi/gallery/04.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@sfi/gallery/04.jpg') ?></a>
				
				
				
				<a href="img/@cases/@sfi/gallery/05.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@sfi/gallery/05.jpg') ?></a>
				
				
				
				<a href="img/@cases/@sfi/gallery/06.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@sfi/gallery/06.jpg') ?></a>
			...
			<div class="gallery__card" data-groupby="2">
				...
				<a href="img/@cases/@sfi/gallery/07.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@sfi/gallery/07.jpg') ?></a>
				
				
				
				<a href="img/@cases/@sfi/gallery/08.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@sfi/gallery/08.jpg') ?></a>
...
<a href="/cases/mvideo-eldorado/" class="cases__card cases__card_next">
	<div>
...
<a href="/cases/safmar/" class="cases__card cases__card_prev">
	<div>

...
<section class="main " id="main" data-bg-desktop="img/@cases/@smc2019/main/bg_d.jpg" data-bg-tablet="img/@cases/@smc2019/main/bg_t.jpg" data-bg-mobile="img/@cases/@smc2019/main/bg.jpg">
	...
	<div class="container">
		...
		<h1 class="main__title">Synergy Management Camp 2019</h1>
...
<section class="stats lazy" id="speakers">
	<div class="container">
		...
		<div class="stats__items" data-count="9">
			
			<div class="stats__item stats__item_1 stats__item_odd stats__item_small">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						
						<div class="stats__item-num-smaller">Евгений <br> Надоршин</div>
						
					</div>
					<div class="stats__item-text">главный экономист &laquo;ПФ&nbsp;Капитал&raquo;</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_2 stats__item_even stats__item_small">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						...
						<div class="stats__item-num-smaller">Тимур <br> Турлов</div>
						
					</div>
					<div class="stats__item-text">генеральный директор, <br> глава инвестиционного комитета <br> компании ИК&nbsp;&laquo;Фридом Финанс&raquo;</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_3 stats__item_odd stats__item_small">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						...
						<div class="stats__item-num-smaller">Евгений <br> Тимофеев</div>
						
					</div>
					<div class="stats__item-text">партнер, <br> руководитель налоговой практики <br> Bryan Cave Leighton Paisner</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_4 stats__item_even stats__item_small">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						...
						<div class="stats__item-num-smaller">Елена <br> Байдалина</div>
						
					</div>
					<div class="stats__item-text">ведущий юрист <br> Synergy Management System</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_5 stats__item_odd stats__item_small">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						...
						<div class="stats__item-num-smaller">Олег <br> Трошин</div>
						
					</div>
					<div class="stats__item-text">директор Департамента <br> консультирования по&nbsp;налогообложению <br> и&nbsp;праву &laquo;Делойт&raquo; в&nbsp;СНГ</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_6 stats__item_even stats__item_small">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						...
						<div class="stats__item-num-smaller">Виталий <br> Соколов</div>
						
					</div>
					<div class="stats__item-text">руководитель направления <br> кибербезопасности PwC Россия</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_7 stats__item_odd stats__item_small">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						...
						<div class="stats__item-num-smaller">Александр <br> Дубовенко</div>
						
					</div>
					<div class="stats__item-text">собственник GOOD WOOD</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_8 stats__item_even stats__item_small">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						...
						<div class="stats__item-num-smaller">Всеволод <br> Гаврилов</div>
						
					</div>
					<div class="stats__item-text">генеральный директор <br> Volvo Penta АО(н) &laquo;Вольво Восток&raquo;</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_9 stats__item_odd stats__item_small">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						...
						<div class="stats__item-num-smaller">Леонид <br> Фейгин</div>
						
					</div>
					<div class="stats__item-text">креативный директор, <br> учредитель Брендингового <br> агентства DDVB</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
	...
	<div class="container gallery__container">
		...
		<div class="gallery__slider slick" data-slick='{ "arrows": false, "touch": false, "mobileFirst": true, "slidesToShow": 1, "slidesToScroll": 1, "responsive": [{"breakpoint": 991, "settings": { "slidesToShow": 3, "slidesToScroll": 3 } }] }'>
			...
			<div class="gallery__card" data-groupby="2">
				...
				<a href="img/@cases/@smc2019/gallery/01.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@smc2019/gallery/01.jpg') ?></a>
				
				
				
				<a href="img/@cases/@smc2019/gallery/02.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@smc2019/gallery/02.jpg') ?></a>
			...
			<div class="gallery__card" data-groupby="4">
				...
				<a href="img/@cases/@smc2019/gallery/03.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@smc2019/gallery/03.jpg') ?></a>
				
				
				
				<a href="img/@cases/@smc2019/gallery/04.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@smc2019/gallery/04.jpg') ?></a>
				
				
				
				<a href="img/@cases/@smc2019/gallery/05.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@smc2019/gallery/05.jpg') ?></a>
				
				
				
				<a href="img/@cases/@smc2019/gallery/06.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@smc2019/gallery/06.jpg') ?></a>
			...
			<div class="gallery__card" data-groupby="2">
				...
				<a href="img/@cases/@smc2019/gallery/07.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@smc2019/gallery/07.jpg') ?></a>
				
				
				
				<a href="img/@cases/@smc2019/gallery/08.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@smc2019/gallery/08.jpg') ?></a>
...
<a href="/cases/kamaz/" class="cases__card cases__card_next">
	<div>
...
<a href="/cases/smc2018/" class="cases__card cases__card_prev">
	<div>

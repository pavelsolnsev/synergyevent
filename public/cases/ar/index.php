...
<section class="main " id="main" data-bg-desktop="img/@cases/@ar/main/bg_d.jpg" data-bg-tablet="img/@cases/@ar/main/bg_t.jpg" data-bg-mobile="img/@cases/@ar/main/bg.jpg">
	...
	<div class="container">
		...
		<h1 class="main__title">ART RUSSIA</h1>
		

		
		<div class="main__subtitle">Серия онлайн-форумов</div>
...
<section class="video" id="video" style="background-image: url('img/@cases/@ar/video/bg_d.jpg')">

	<a href="https://youtu.be/FI3zXRSAJ1c" target="_blank" data-fancybox class="video__link">
...
<section class="stats lazy" id="stats">
	<div class="container">
		...
		<div class="stats__subtitle">Концепция форума: идея гармоничного развития человека в&nbsp;области и&nbsp;физической культуры наряду с&nbsp;традиционным искусством</div>

		

		<div class="stats__items" data-count="3">
			...
			<div class="stats__item stats__item_1 stats__item_odd stats__item_small">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">сцены</div>
			...
			<div class="stats__item stats__item_2 stats__item_even stats__item_small">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">просмотров всех сцен форума</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_3 stats__item_odd stats__item_small">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">вещание в прямом эфире</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_1 stats__item_odd ">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						...
						<div class="stats__item-num-smaller">Люк <br> Бессон</div>
						
					</div>
					<div class="stats__item-text">французский кинорежиссёр, сценарист,<br> продюсер и&nbsp;писатель. <br> Режиссер культовых фильмов <br> &laquo;Пятый элемент&raquo;, &laquo;Леон&raquo;</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_2 stats__item_even ">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						...
						<div class="stats__item-num-smaller">Чжан <br> Хуань</div>
						
					</div>
					<div class="stats__item-text">всемирно известный китайский художник,<br> работы которого находятся в&nbsp;Музее <br> современного искусства и&nbsp;Музее <br> Гуггенхейма в&nbsp;Нью-Йорке, <br> Центре Жоржа Помпиду в&nbsp;Париже.</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_3 stats__item_odd ">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						...
						<div class="stats__item-num-smaller">Лорензо <br> Куинн</div>
						
					</div>
					<div class="stats__item-text">итальянский художник и&nbsp;скульптор</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_4 stats__item_even ">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						...
						<div class="stats__item-num-smaller">Перукуа</div>
						
					</div>
					<div class="stats__item-text">австралийская джазовая певица, <br> известная на&nbsp;весь мир как <br> &laquo;Голос Матери-Земли&raquo; и&nbsp;&laquo;Голос Сокровенной Женственности&raquo;</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_5 stats__item_odd ">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						...
						<div class="stats__item-num-smaller">Стивен <br> Ридли</div>
						
					</div>
					<div class="stats__item-text">пианист, певец</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_6 stats__item_even ">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						...
						<div class="stats__item-num-smaller">Артемий <br> Троицкий</div>
						
					</div>
					<div class="stats__item-text">рок-журналист, <br> ведущий музыкальный критик</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_7 stats__item_odd ">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						...
						<div class="stats__item-num-smaller">Найк <br> Борзов</div>
						
					</div>
					<div class="stats__item-text">российский рок-музыкант</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_8 stats__item_even ">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						...
						<div class="stats__item-num-smaller">Андрей <br> Бартенев</div>
						
					</div>
					<div class="stats__item-text">художник, скульптор, <br> дизайнер, экспериментатор</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
	...
	<div class="container gallery__container">
		...
		<div class="gallery__slider slick" data-slick='{ "arrows": false, "touch": false, "mobileFirst": true, "slidesToShow": 1, "slidesToScroll": 1, "responsive": [{"breakpoint": 991, "settings": { "slidesToShow": 3, "slidesToScroll": 3 } }] }'>
			...
			<div class="gallery__card" data-groupby="2">
				...
				<a href="img/@cases/@ar/gallery/" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@ar/gallery/') ?></a>
...
<a href="/cases/sfi/" class="cases__card cases__card_next">
	<div>
...
<a href="/cases/kamaz/" class="cases__card cases__card_prev">
	<div>

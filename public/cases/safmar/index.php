...
<section class="main " id="main" data-bg-desktop="img/@cases/@safmar/main/bg_d.jpg" data-bg-tablet="img/@cases/@safmar/main/bg_t.jpg" data-bg-mobile="img/@cases/@safmar/main/bg.jpg">
	...
	<div class="container">
		...
		<h1 class="main__title">САФМАР на&nbsp;одной волне!</h1>
		

		
		<div class="main__subtitle">Парусная регата и&nbsp;гала-ужин ГК&nbsp;САФМАР</div>
	...
	<div class="container">
		...
		<div class="row no-gutters">
			<div class="col-lg-7 about__col-1">
				...
				<div class="about__text">Командообразующее событие для сотрудников.</div>
...
<section class="video" id="video" style="background-image: url('img/@cases/@safmar/video/bg_d.jpg')">

	<a href="https://youtu.be/wI8iVCrq6qo" target="_blank" data-fancybox class="video__link">
...
<section class="stats lazy" id="stats">
	<div class="container">
		...
		<div class="stats__subtitle">Насыщенное мультиформатное событие, объединившее в&nbsp;себе драйвовую парусную регату и&nbsp;торжественный гала-ужин, который также не&nbsp;обошелся без командообразующей составляющей.</div>
		...
		<div class="stats__items" data-count="3">
			...
			<div class="stats__item stats__item_1 stats__item_odd stats__item_small">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">экипажей</div>
			...
			<div class="stats__item stats__item_2 stats__item_even stats__item_small">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">сотрудников и менеджеров САМФАР</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_3 stats__item_odd stats__item_small">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">Развлекательные программы:<br> &laquo;Большой квиз&raquo; <br>&laquo;Подмосковные вечера&raquo;</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
	...
	<div class="container gallery__container">
		...
		<div class="gallery__slider slick" data-slick='{ "arrows": false, "touch": false, "mobileFirst": true, "slidesToShow": 1, "slidesToScroll": 1, "responsive": [{"breakpoint": 991, "settings": { "slidesToShow": 3, "slidesToScroll": 3 } }] }'>
			...
			<div class="gallery__card" data-groupby="2">
				...
				<a href="img/@cases/@safmar/gallery/01.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@safmar/gallery/01.jpg') ?></a>
				
				
				
				<a href="img/@cases/@safmar/gallery/02.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@safmar/gallery/02.jpg') ?></a>
			...
			<div class="gallery__card" data-groupby="4">
				...
				<a href="img/@cases/@safmar/gallery/03.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@safmar/gallery/03.jpg') ?></a>
				
				
				
				<a href="img/@cases/@safmar/gallery/04.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@safmar/gallery/04.jpg') ?></a>
				
				
				
				<a href="img/@cases/@safmar/gallery/05.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@safmar/gallery/05.jpg') ?></a>
				
				
				
				<a href="img/@cases/@safmar/gallery/06.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@safmar/gallery/06.jpg') ?></a>
			...
			<div class="gallery__card" data-groupby="2">
				...
				<a href="img/@cases/@safmar/gallery/07.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@safmar/gallery/07.jpg') ?></a>
				
				
				
				<a href="img/@cases/@safmar/gallery/08.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@safmar/gallery/08.jpg') ?></a>

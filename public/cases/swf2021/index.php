...
<section class="main " id="main" data-bg-desktop="img/@cases/@swf2021/main/bg_d.jpg" data-bg-tablet="img/@cases/@swf2021/main/bg_t.jpg" data-bg-mobile="img/@cases/@swf2021/main/bg.jpg">
	...
	<div class="container">
		...
		<h1 class="main__title">Synergy Woman Forum 2021</h1>
		

		
		<div class="main__subtitle">Главное ежегодное событие для женщин, которые хотят быть в&nbsp;тренде, жить ярко и&nbsp;успевать все. </div>
	...
	<div class="container">
		...
		<div class="row no-gutters">
			<div class="col-lg-7 about__col-1">
				...
				<div class="about__text">Synergy Event Forum&nbsp;&mdash; событие, которое даёт слушательницам ключи к&nbsp;достижению новых целей, новые идеи и&nbsp;заряд энергии на&nbsp;целый год.</div>
...
<section class="video" id="video" style="background-image: url('img/@cases/@swf2021/video/bg_d.jpg')">

	<a href="https://youtu.be/8Ws6d5F0AKc" target="_blank" data-fancybox class="video__link">
...
<section class="stats lazy" id="stats">
	<div class="container">
		...
		<div class="stats__subtitle">Спикеры форума&nbsp;&mdash; женщины, вдохновляющие на&nbsp;развитие и&nbsp;новые свершения, добившиеся успеха в&nbsp;бизнесе, спорте, моде, искусстве и&nbsp;медиа.</div>
		...
		<div class="stats__items" data-count="4">
			...
			<div class="stats__item stats__item_1 stats__item_odd ">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">сцен с&nbsp;онлайн-трансляцией</div>
			...
			<div class="stats__item stats__item_2 stats__item_even ">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">спикеров со всего мира</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_3 stats__item_odd ">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">часов экспертного контента</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_4 stats__item_even ">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">известных спикеров</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
	...
	<div class="container gallery__container">
		...
		<div class="gallery__slider slick" data-slick='{ "arrows": false, "touch": false, "mobileFirst": true, "slidesToShow": 1, "slidesToScroll": 1, "responsive": [{"breakpoint": 991, "settings": { "slidesToShow": 3, "slidesToScroll": 3 } }] }'>
			...
			<div class="gallery__card" data-groupby="2">
				...
				<a href="img/@cases/@swf2021/gallery/01.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@swf2021/gallery/01.jpg') ?></a>
				
				
				
				<a href="img/@cases/@swf2021/gallery/02.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@swf2021/gallery/02.jpg') ?></a>
			...
			<div class="gallery__card" data-groupby="4">
				...
				<a href="img/@cases/@swf2021/gallery/03.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@swf2021/gallery/03.jpg') ?></a>
				
				
				
				<a href="img/@cases/@swf2021/gallery/04.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@swf2021/gallery/04.jpg') ?></a>
				
				
				
				<a href="img/@cases/@swf2021/gallery/05.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@swf2021/gallery/05.jpg') ?></a>
				
				
				
				<a href="img/@cases/@swf2021/gallery/06.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@swf2021/gallery/06.jpg') ?></a>
			...
			<div class="gallery__card" data-groupby="2">
				...
				<a href="img/@cases/@swf2021/gallery/07.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@swf2021/gallery/07.jpg') ?></a>
				
				
				
				<a href="img/@cases/@swf2021/gallery/08.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@swf2021/gallery/08.jpg') ?></a>
...
<a href="/cases/smc2018/" class="cases__card cases__card_next">
	<div>
...
<a href="/cases/mb/" class="cases__card cases__card_prev">
	<div>

...
<section class="main " id="main" data-bg-desktop="img/@cases/@smc2018/main/bg_d.jpg" data-bg-tablet="img/@cases/@smc2018/main/bg_t.jpg" data-bg-mobile="img/@cases/@smc2018/main/bg.jpg">
	...
	<div class="container">
		...
		<h1 class="main__title">Synergy Management Camp 2018</h1>
	...
	<div class="container">
		...
		<div class="row no-gutters">
			<div class="col-lg-7 about__col-1">
				...
				<div class="about__text">Найти новые возможности для развития бизнеса&nbsp;&mdash; обмен опытом с&nbsp;коллегами и&nbsp;анализ успешных кейсов.</div>
...
<section class="video" id="video" style="background-image: url('img/@cases/@smc2018/video/bg_d.jpg')">

	<a href="https://youtu.be/nWcQyXVNQK0" target="_blank" data-fancybox class="video__link">
...
<section class="stats lazy" id="stats">
	<div class="container">
		...
		<div class="stats__subtitle">Бизнес-форум для собственников и&nbsp;топ-менеджеров российских компаний.</div>

		

		<div class="stats__items" data-count="2">
			
			<div class="stats__item stats__item_1 stats__item_odd ">
				<div class="stats__item-inner">
					...
					<div class="stats__item-text">участников</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			
			<div class="stats__item stats__item_2 stats__item_even ">
				<div class="stats__item-inner">
					<div class="stats__item-num">
					...
					<div class="stats__item-text">эксперта по различным направлениям <br> развития бизнеса</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
...
<section class="stats lazy" id="speakers">
	<div class="container">

		<h2 class="stats__title">Спикеры</h2>
		<div class="stats__subtitle"></div>

		

		<div class="stats__items" data-count="8">
			
			<div class="stats__item stats__item_1 stats__item_odd ">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						
						<div class="stats__item-num-smaller">Светлана <br> Мейер</div>
						
					</div>
					<div class="stats__item-text">управляющий партнёр департамента <br> консультирования по&nbsp;налогообложению <br> и&nbsp;праву компании &laquo;Делойт&raquo; (СНГ)</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			...
			<div class="stats__item stats__item_2 stats__item_even ">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						...
						<div class="stats__item-num-smaller">Галина <br> Акчурина</div>
						
					</div>
					<div class="stats__item-text">партнёр, директор департамента <br> налоговых споров ФБК &laquo;Право&raquo;</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			
			<div class="stats__item stats__item_3 stats__item_odd ">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						
						<div class="stats__item-num-smaller">Алексей <br> Романенко</div>
						
					</div>
					<div class="stats__item-text">партнёр, руководитель отдела <br> управленческого консультирования KPMG</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			
			<div class="stats__item stats__item_4 stats__item_even ">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						
						<div class="stats__item-num-smaller">Константин <br> Суплатов</div>
						
					</div>
					<div class="stats__item-text">директор, руководитель практики <br> консультационных услуг в&nbsp;области <br> казначейства и&nbsp;товарно-сырьевых <br> рисков PwC&nbsp;в России</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			
			<div class="stats__item stats__item_5 stats__item_odd ">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						
						<div class="stats__item-num-smaller">Сергей <br> Анурьев</div>
						
					</div>
					<div class="stats__item-text">генеральный директор <br> компании &laquo;ЛитРес&raquo;</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			
			<div class="stats__item stats__item_6 stats__item_even ">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						
						<div class="stats__item-num-smaller">Олег <br> Коннов</div>
						
					</div>
					<div class="stats__item-text">партнёр, <br> руководитель налоговой практики <br> Herbert Smith Freehills</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			
			<div class="stats__item stats__item_7 stats__item_odd ">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						
						<div class="stats__item-num-smaller">Михаил <br> Горбачев</div>
						
					</div>
					<div class="stats__item-text">финансовый директор IEK Group</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
			
			<div class="stats__item stats__item_8 stats__item_even ">
				<div class="stats__item-inner">
					<div class="stats__item-num">
						
						<div class="stats__item-num-smaller">Александр <br> Рагиня</div>
						
					</div>
					<div class="stats__item-text">исполнительный директор <br> Synergy Management System</div>
				</div><!-- stats__item-inner -->
			</div><!-- stats__item -->
	...
	<div class="container gallery__container">
		...
		<div class="gallery__slider slick" data-slick='{ "arrows": false, "touch": false, "mobileFirst": true, "slidesToShow": 1, "slidesToScroll": 1, "responsive": [{"breakpoint": 991, "settings": { "slidesToShow": 3, "slidesToScroll": 3 } }] }'>
			...
			<div class="gallery__card" data-groupby="2">
				...
				<a href="img/@cases/@smc2018/gallery/01.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@smc2018/gallery/01.jpg') ?></a>
				
				
				
				<a href="img/@cases/@smc2018/gallery/02.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@smc2018/gallery/02.jpg') ?></a>
			...
			<div class="gallery__card" data-groupby="4">
				...
				<a href="img/@cases/@smc2018/gallery/03.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@smc2018/gallery/03.jpg') ?></a>
				
				
				
				<a href="img/@cases/@smc2018/gallery/04.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@smc2018/gallery/04.jpg') ?></a>
				
				
				
				<a href="img/@cases/@smc2018/gallery/05.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@smc2018/gallery/05.jpg') ?></a>
				
				
				
				<a href="img/@cases/@smc2018/gallery/06.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@smc2018/gallery/06.jpg') ?></a>
			...
			<div class="gallery__card" data-groupby="2">
				...
				<a href="img/@cases/@smc2018/gallery/07.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@smc2018/gallery/07.jpg') ?></a>
				
				
				
				<a href="img/@cases/@smc2018/gallery/08.jpg" target="_blank" data-fancybox="gallery__card" data-options='{"toolbar": false, "smallBtn": true, "arrows": false, "buttons": ["close"]}' class="gallery__card-img"><?= img('img/@cases/@smc2018/gallery/08.jpg') ?></a>
...
<a href="/cases/smc2019/" class="cases__card cases__card_next">
	<div>
...
<a href="/cases/swf2021/" class="cases__card cases__card_prev">
	<div>
